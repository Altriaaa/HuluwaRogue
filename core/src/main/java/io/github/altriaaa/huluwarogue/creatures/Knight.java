...
public class Knight extends Creature
{
    ...
    public Knight(final Main game, GameScreen gameScreen)
    {
        ...
        speed = 128f* Gdx.graphics.getDeltaTime();
    ...
    public void act(float delta)
    {
        ...
        if (Gdx.input.isKeyPressed(Input.Keys.D)) {
            ...
            nextX += speed; // Move right
        }
        else if (Gdx.input.isKeyPressed(Input.Keys.A)) {
            setState(CharacterState.WALKING);
            nextX -= speed; // Move left
        }
        ...
        for(Orc enemy : gameScreen.getEnemies())
        {
        ...
        for(Obstacle o : gameScreen.getObstacles())
        {
